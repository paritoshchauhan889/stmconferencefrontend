...
const Privacy = () => {
  ...
  <p>Welcome to <b>STM Conferences</b>.</p>
  <p><b>STM Conferences</b> (“us”, “we”, or “our”) operates at <b>https://stmconferences.com/</b> (hereinafter
    referred to as <b>“Service”</b>).</p>
  <p>Our Privacy Policy governs your visit to <b>https://stmconferences.com/</b> and explains how we collect,
    safeguard and disclose information that results from your use of our Service.</p>
  <p>We use your data to provide and improve Service. By using the Service, you agree to the collection and use of
  ...
  <p><b>Our Terms and Conditions (“Terms”) govern all use of our Service and together with the Privacy Policy
      constitute your agreement with us (“Agreement”).</b></p>
  <h5>2. Definitions</h5>
  <p><b>SERVICE </b>means the https://stmconferences.com/ website operated by STM Conferences.</p>
  ...
  <p><b>USAGE DATA</b> is data collected automatically either generated by the use of the Service or from the
  ...
  <p>We may use and store information about your location if you give us permission to do so <b>(“Location
      Data”)</b>. We use this data to provide features of our Service, and to improve and customize our
    Service.</p>
  ...
  </p><p>0.2. <b>Preference Cookies:</b> We use Preference Cookies to remember your preferences and various settings.
  </p><p>0.3. <b>Security Cookies:</b>We use Security Cookies for security purposes.
  </p><p>0.4. <b>Advertising Cookies:</b> Advertising Cookies are used to serve you with advertisements that may be
  ...
  <p>While using our Service, we may also collect the following information: sex, age, date of birth, place of
    ...
    agreements, <b style={{color: '#29a97b'}}>NDA agreements,</b> information on bonuses and compensation,
    information on marital status, family members, social security (or other taxpayer identification) number,
    office location, and other data.</p>
  <h6>5. Use of Data</h6>
  <p>STM Conferences uses the collected data for various purposes:</p>
  ...
  <p>0.8. to fulfill any other purpose for which you provide it;
  </p>
  ...
  <p>If you are located outside India and choose to provide information to us, please note that we transfer the
  ...
  <p>STM Conferences will take all the steps reasonably necessary to ensure that your data is treated securely and
  ...
  <h6>10. Your Data Protection Rights Under General Data Protection Regulation (GDPR)
  </h6>
  ...
  <p>If you wish to be informed what Personal Data we hold about you and if you want it to be removed from our
    systems, please email us at info@stmjournals.com.
  </p>
  <p>In certain circumstances, you have the following data protection rights:
  </p>
  <p>0.1. the right to access, update or delete the information we have on you;
  </p>
  ...
  <p>0.6. the right to withdraw consent. You also have the right to withdraw your consent at any time when we rely
  ...
  <h6>11. Your Data Protection Rights under the California Privacy Protection Act (CalOPPA)
  </h6>
  ...
  <p>0.4. users are able to change their personal information by emailing us at <b>info@stmjournals.com</b>.
  </p>
  ...
  <h6>13. Service Providers
  </h6>
  <p>We may employ third-party companies and individuals to facilitate our Service <b>(“Service Providers”)</b>, provide Service on our behalf, perform Service-related services or assist us in analyzing how our Service is used.
  </p>
  ...
  <h6>16. Behavioral Remarketing
  </h6>
  <p>We may use remarketing services to advertise on third-party websites to you after you visited our Service. We and our third-party vendors use cookies to inform, optimize and serve ads based on your past visits to our Service.
  </p>
  <h6>17. Payments
  </h6>
  ...
  <h6>19. Children’s Privacy
  </h6>
  <p>Our Services are not intended for use by children under the age of 18 <b>(“Child” or “Children”)</b>.
  </p>
  ...
  <p>If you have any questions about this Privacy Policy, please contact us by email: <b>info@stmjournals.com</b>.
  </p>
</div>
    </Layout>
  )
